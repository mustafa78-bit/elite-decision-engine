...
export function ExposureWidget({
  ...
  return (
    <Card className="h-full">
      <CardHeader>
        <CardTitle>{t("exposureWidget.title")}</CardTitle>
      </CardHeader>
      <CardContent className="space-y-3">
        <div className="grid grid-cols-2 gap-2">
          <div className="p-2 rounded-lg bg-[var(--accent-green)]/5 border border-[var(--accent-green)]/10">
            <div className="text-[10px] text-[var(--text-muted)]">{t("exposureWidget.long")}</div>
          ...
          <div className="p-2 rounded-lg bg-[var(--accent-red)]/5 border border-[var(--accent-red)]/10">
            <div className="text-[10px] text-[var(--text-muted)]">{t("exposureWidget.short")}</div>
        ...
        <div>
          <div className="flex justify-between text-[10px] text-[var(--text-muted)] mb-1">
            <span>{t("exposureWidget.usage")}</span>
        ...
        <div className="flex justify-between text-[10px]">
          <span className="text-[var(--text-muted)]">{t("exposureWidget.buyingPower")}</span>
