    ...
    <Card className="h-full">
      <CardContent className="p-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            <div className="text-[12px] text-[var(--text-muted)]">Total PnL</div>
            <div
          ...
          <div>
            <div className="text-[12px] text-[var(--text-muted)]">Win Rate</div>
            <div className="text-sm font-mono tabular-nums text-[var(--text-primary)]">
              {p.win_rate.toFixed(1)}%
            </div>
          </div>
          <div>
            <div className="text-[12px] text-[var(--text-muted)]">Open Trades</div>
            <div className="text-sm font-mono tabular-nums text-[var(--text-primary)]">
              {p.open_trades}
            </div>
          </div>
          <div>
            <div className="text-[12px] text-[var(--text-muted)]">Profit Factor</div>
            <div className="text-sm font-mono tabular-nums text-[var(--text-primary)]">
