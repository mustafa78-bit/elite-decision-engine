    ...
    <Card className="h-full">
      <CardContent className="p-4">
        <div className="text-[10px] font-medium text-[var(--text-muted)] uppercase tracking-[0.08em] mb-3">
          {t("portfolioSummaryWidget.title")}
        </div>
        <div className="grid grid-cols-2 gap-3">
          <div>
            <div className="text-[10px] text-[var(--text-muted)]">{t("portfolioSummaryWidget.totalPnl")}</div>
            <div
          ...
          <div>
            <div className="text-[10px] text-[var(--text-muted)]">{t("portfolioSummaryWidget.winRate")}</div>
            <div className="text-sm font-mono tabular-nums text-[var(--text-primary)]">
              {p.win_rate.toFixed(1)}%
            </div>
          </div>
          <div>
            <div className="text-[10px] text-[var(--text-muted)]">{t("portfolioSummaryWidget.openTrades")}</div>
            <div className="text-sm font-mono tabular-nums text-[var(--text-primary)]">
              {p.open_trades}
            </div>
          </div>
          <div>
            <div className="text-[10px] text-[var(--text-muted)]">{t("portfolioSummaryWidget.maxDrawdown")}</div>
            <div className="text-sm font-mono tabular-nums text-[var(--text-primary)]">
