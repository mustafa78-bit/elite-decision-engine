          ...
          <div className="p-3 space-y-3">
            ...
            <div className="widget-card">
              <div className="widget-header">
                <span className="text-[12px] font-semibold text-[var(--text-secondary)] uppercase tracking-[0.08em]">
                  AI Summary
                </span>
              </div>
            ...
            <div className="widget-card">
              ...
              <div className="widget-body space-y-2.5">
                ...
                <div className="flex justify-between text-[12.5px]">
                  ...
                  <span className={`font-mono font-semibold tabular-nums ${change24h >= 0 ? "text-[var(--accent-green)]" : "text-[var(--accent-red)]"}`}>
                    {context.latestPrice ? `${change24h >= 0 ? "+" : ""}${change24h.toFixed(2)}%` : "--"}
                  </span>
                </div>
                <div className="flex justify-between text-[12.5px]">
                  <span className="text-[var(--text-secondary)]">Signal</span>
                  <span className={`font-mono font-semibold tabular-nums ${context.latestSignal ? "text-[var(--accent-green)]" : "text-[var(--text-primary)]"}`}>
                    {context.latestSignal ? context.latestSignal.decision : "NONE"}
                  </span>
                </div>
                <div className="flex justify-between text-[12.5px]">
                  <span className="text-[var(--text-secondary)]">Risk</span>
                  <span className="font-mono font-semibold tabular-nums text-[var(--accent-yellow)]">
