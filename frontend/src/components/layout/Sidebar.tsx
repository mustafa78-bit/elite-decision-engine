    ...
    <aside className="w-56 h-full flex flex-col bg-[var(--bg-base)] border-r border-[var(--border-subtle)] shrink-0 overflow-y-auto">
      <div className="px-4 py-4 border-b border-[var(--border-subtle)]">
        <div className="flex items-center gap-2">
          ...
          />
          <span className="text-sm font-bold text-[var(--text-primary)] tracking-tight sidebar-title">
            Elite HQ
          </span>
        </div>
        <p className="text-[10px] text-[var(--text-muted)] mt-1 font-mono uppercase tracking-[0.05em] font-bold sidebar-subtitle">
            ...
            <div key={section.title}>
              <div className="px-2 mb-1 flex items-center gap-2">
                ...
                <div className="min-w-0">
                  <div className="text-[9px] font-bold text-[var(--text-muted)] uppercase tracking-[0.05em] leading-tight sidebar-section-title">
                    {section.title}
                  </div>
                  <div className="text-[7px] text-[var(--text-muted)] font-mono uppercase tracking-[0.04em] font-bold sidebar-subtitle">
                    {section.subtitle}
                  </div>
                </div>
              </div>
              {section.items.map((item) => {
                ...
                return (
                  <NavLink
                    ...
                    to={item.path}
                    className={cn(
                      "flex items-center gap-2.5 px-3 py-1.5 rounded-lg text-xs font-semibold transition-all duration-200 sidebar-menu-item",
                      isActive
      ...
      <div className="px-4 py-3 border-t border-[var(--border-subtle)]">
        <div className="flex items-center gap-2">
          ...
          />
          <span className="text-[10px] text-[var(--text-muted)] font-mono font-bold sidebar-subtitle">
            System Online
          </span>
        </div>
      </div>
