  ...
  return (
    <div className="bg-gray-900 border border-gray-800 rounded p-4">
      ...
      <div className="grid grid-cols-2 gap-3 text-xs">
        ...
        <div>
          <div className="text-[var(--text-muted)] text-[9px] uppercase tracking-wider">Win Rate</div>
          <div className="text-green-400 font-semibold tabular-nums">{winRate.toFixed(1)}%</div>
        </div>
        <div>
          <div className="text-[var(--text-muted)] text-[9px] uppercase tracking-wider">Wins</div>
          <div className="text-green-400 font-semibold tabular-nums">{winningTrades}</div>
        </div>
        <div>
          <div className="text-[var(--text-muted)] text-[9px] uppercase tracking-wider">Losses</div>
