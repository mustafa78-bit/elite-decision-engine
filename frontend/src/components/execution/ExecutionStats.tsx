  ...
  return (
    <div className="bg-gray-900 border border-gray-800 rounded p-4">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
        <div>
          <div className="text-[9px] text-gray-600 uppercase tracking-wider">Signals Total</div>
          <div className="text-lg font-semibold tabular-nums text-gray-200">{signals.total}</div>
        </div>
        <div>
          <div className="text-[9px] text-gray-600 uppercase tracking-wider">Execution Rate</div>
          <div className="text-lg font-semibold tabular-nums text-green-400">{signals.execution_rate}%</div>
        </div>
        <div>
          <div className="text-[9px] text-gray-600 uppercase tracking-wider">Approved</div>
          <div className="text-lg font-semibold tabular-nums text-green-400">{signals.approved}</div>
        </div>
        <div>
          <div className="text-[9px] text-gray-600 uppercase tracking-wider">Rejected</div>
          <div className="text-lg font-semibold tabular-nums text-red-400">{signals.rejected}</div>
        </div>
        <div>
          <div className="text-[9px] text-gray-600 uppercase tracking-wider">Trades Total</div>
          <div className="text-lg font-semibold tabular-nums text-gray-200">{trades.total}</div>
        </div>
        <div>
          <div className="text-[9px] text-gray-600 uppercase tracking-wider">Open</div>
          <div className="text-lg font-semibold tabular-nums text-blue-400">{trades.open}</div>
        </div>
        <div>
          <div className="text-[9px] text-gray-600 uppercase tracking-wider">TP Hit</div>
          <div className="text-lg font-semibold tabular-nums text-green-400">{trades.tp_hit}</div>
        </div>
        <div>
          <div className="text-[9px] text-gray-600 uppercase tracking-wider">SL Hit</div>
