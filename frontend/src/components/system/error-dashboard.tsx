  ...
  return (
    <Card className="h-full">
      ...
      <CardContent className="space-y-1.5 max-h-64 overflow-y-auto">
        {errors.map((e) => (
          <div key={e.id} className={`p-2 rounded-lg border text-[9px] font-mono ${e.resolved ? "bg-[var(--bg-base)]/50 border-[var(--border-subtle)] " : "bg-[var(--bg-base)] border-[var(--border-subtle)]"}`}>
