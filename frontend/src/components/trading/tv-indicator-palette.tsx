  ...
  return (
    <div className="relative">
      <button
        ...
        className="px-2 py-1 rounded-lg bg-[var(--bg-elevated)] border border-[var(--border-default)] text-[12px] font-mono text-[var(--text-secondary)] hover:text-[var(--text-primary)] transition-all"
      >
