  ...
  return (
    <div className="bg-gray-900 border border-gray-800 rounded p-4">
      ...
      <div className="grid grid-cols-2 gap-3 text-xs">
        ...
        <div>
          <div className="text-[var(--text-muted)] text-[9px] uppercase tracking-wider">Trend</div>
      ...
      <div className="mt-3 pt-3 border-t border-gray-800 text-[10px] text-[var(--text-muted)]">
