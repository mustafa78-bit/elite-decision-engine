      ...
      {intelligence ? (
        <div className="space-y-3">
          <div className="text-center py-2">
            <p className="text-[12px] uppercase tracking-widest text-[var(--text-muted)] mb-1">AI Council</p>
          ...
          <div className="border-t border-gray-800 pt-2">
            <p className="text-[12px] uppercase tracking-widest text-[var(--text-muted)] mb-1.5">Decision Factors</p>
        ...
        <div className="flex flex-col items-center justify-center py-6 text-center">
          ...
          <p className="text-[13px] text-[var(--text-muted)] font-mono">No intelligence available yet</p>
          <p className="text-[12px] text-[var(--text-muted)]  mt-1 max-w-[180px]">
