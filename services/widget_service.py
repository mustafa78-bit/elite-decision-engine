...
class WidgetService:
    ...
    def _kpi_widget(self, **kwargs: Any) -> dict[str, Any]:
    ...
    def _portfolio_widget(self, **kwargs: Any) -> dict[str, Any]:
    ...
    def _monitoring_widget(self, **kwargs: Any) -> dict[str, Any]:
    ...
    def _notifications_widget(self, limit: int = 10, **kwargs: Any) -> dict[str, Any]:
        session = self.session_factory()
        try:
